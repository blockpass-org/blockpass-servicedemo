        ...
        return {
            ...
            filterDropdown: (
                <div style={customFilterDropdownStyle}>
                    ...
                    />
                    <Button type="primary" onClick={e => this._onSearch(column.dataIndex)}>Apply</Button>
                </div>
            ),
            filterIcon: <Icon type="search" style={{ color: this.state.filtered[filteredControlFields] ? '#108ee9' : '#aaa' }} />,
